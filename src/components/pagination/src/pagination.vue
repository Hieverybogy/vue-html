<template>
    ...
    <ul :class="wrapClasses" v-else>
        ...
        <li
                ...
                class="zs-icon-left"
                @click="prev">
            <!--<a><i class="zs-icon-left"></i></a>-->
        </li>
        <li title="1" :class="firstPageClasses" @click="changePage(1)"><a>1</a></li>
        <li v-if="currentPage - 3 > 1" :class="[prefixCls + '__item-jump-prev','zs-icon-']"
            @click="fastPrev">
            <a><i class="zs-icon-"></i></a>
        </li>
        ...
        <li v-if="currentPage + 3 < allPages" :class="[prefixCls + '__item-jump-next','zs-icon-']"
            @click="fastNext">
            <a><i class="zs-icon-"></i></a>
        </li>
