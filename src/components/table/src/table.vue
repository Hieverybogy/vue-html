    ...
    <div :class="wrapClasses" :style="wrapStyle">
        <div :class="classes">
            ...
            <table cellspacing="0" cellpadding="0" border="0">
                ...
                <tbody v-else>
                <tr>
                    <td class="no-data" :colspan="noDataColspan" style="text-align:center;padding-top:15px;">
                        <span v-if="!data || data.length === 0">{{ noDataText }}</span>
                        <span v-else>{{ noFilteredDataText }}</span>
                    </td>
                </tr>
                </tbody>
            </table>
