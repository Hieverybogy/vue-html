<template>
    <label class="zs-switch"
           :class="[customClass,{'is-disabled': disabled, 'zs-switch__wide': hasText }]">
        <div class="zs-switch__mask" v-show="disabled"></div>
        <input
                class="zs-switch__input"
                type="checkbox"
                @change="handleChange"
                v-model="_value"
                :name="name"
                :disabled="disabled">
        <span class="zs-switch__core" ref="core" :style="{ 'width': coreWidth + 'px' }">
            <span class="zs-switch__button" :style="buttonStyle"></span>
        </span>
        <transition name="label-fade">
            <div
                    class="zs-switch__label zs-switch__label-left"
                    v-show="value"
        ...
        <transition name="label-fade">
            <div
                    class="zs-switch__label zs-switch__label-right"
                    v-show="!value"
                    :style="{ 'width': coreWidth + 'px' }">
