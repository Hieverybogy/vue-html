<template>
    <div class="subform-list-place" @click="handleTdOut" v-if="!!vnode.attrs">
        ...
        >
            ...
            <li @click.stop="handleDelCol" v-if="vnode.attrs.dataForm.length>1">删除列</li>
        </ul>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        // 向右插入列
        handleAddCol() {
            this.vnode.attrs.dataForm.splice(this.thIndex + 1, 0,  {title: '列名', align: 'left', width: '', key: '', txt: '', useMatch: 'none', matchOptions: [], isLink: false, linkType: 'link', linkPath: '',linkMethod: ''});
            this.handleTdOut()
            this.ueditor.addRecord();
        },
        handleDelCol() {
