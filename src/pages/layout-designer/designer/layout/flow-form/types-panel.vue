...
<script>
    ...
    export default {
        ...
        methods: {
            moveFun (evt) {
                if (evt.related && evt.related.className.indexOf('collapses-draggable-wrap') > -1
                    || evt.to && (evt.to.className.indexOf('collapses-draggable-wrap') > -1 || evt.to.className.indexOf('table-form-draggable') > -1)) {
                    return false
                }
            },
            moveEnhanceFun(evt) {
                if (evt.dragged && evt.dragged.className.indexOf('type-tableForm') > -1 && evt.to && evt.to.className.indexOf('table-form-draggable') > -1) {
                    return false
                }
            }
        }
